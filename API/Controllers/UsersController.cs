...
namespace API.Controllers
{
    ...
    public class UsersController : BaseApiController
    {
        ...
        [HttpGet("{username}", Name = "GetUser")] //url path
        public async Task<ActionResult<MemberDto>> GetUsers(string username)
        {
            return await this._unitOfWork.UserRepository.GetMemberAsync(username);
        }

        [HttpPut]
        public async Task<ActionResult> UpdateUser(MemberUpdateDto memberUpdateDto)
        {
            var user = await this._unitOfWork.UserRepository.GetUserByUsernameAsync(
                User.GetUsername()
            );
        ...
        public async Task<ActionResult> SetMainPhoto(int photoId)
        {
            ...
            if (photo.IsMain)
                return BadRequest("this is ready your main photo");
